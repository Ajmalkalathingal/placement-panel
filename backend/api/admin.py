...
from .models import User,StudentProfile,RecruiterProfile,Job,StudentRegistration,CoordinatorRegistration,CoordinatorProfile,InterviewDetails,PasswordResetToken,JobApplication
