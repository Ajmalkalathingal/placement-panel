    ...
    <div className="row">
        <div className="col-md-4 col-xl-3">
            <div className="card bg-c-blue order-card">
                <div className="card-block">
                    <h6 className="m-b-20">Total number of Applicants</h6>
                    <h2 className="text-right"><i className="fa fa-cart-plus f-left"></i><span>486</span></h2>
                    <p className="m-b-0">Total number of Applicants<span className="f-right">351</span></p>
                </div>
            </div>
        </div>
        ...
        <div className="col-md-4 col-xl-3">
            <div className="card bg-c-green order-card">
                <div className="card-block">
                    <h6 className="m-b-20">Total number of Posts</h6>
                    <h2 className="text-right"><i className="fa fa-rocket f-left"></i><span>486</span></h2>
                    <p className="m-b-0">Total number of Posts<span className="f-right">351</span></p>
                </div>
            </div>
        </div>
        ...
        <div className="col-md-4 col-xl-3">
            <div className="card bg-c-pink order-card">
                <div className="card-block">
                    <h6 className="m-b-20">Selected Student</h6>
                    <h2 className="text-right"><i className="fa fa-credit-card f-left"></i><span>486</span></h2>
                    <p className="m-b-0">Selected Student<span className="f-right">351</span></p>
                </div>
            </div>
        </div>
	</div>
